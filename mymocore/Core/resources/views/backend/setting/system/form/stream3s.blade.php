<form method="post" action="{{ route('admin.setting.save') }}" class="form-ajax">
    ...
    <div class="form-group">
        <label class="col-form-label" for="stream3s_use">@lang('mymo_core::app.stream3s_stream')</label>
        <select name="stream3s_use" id="stream3s_use" class="form-control">
            <option value="1" @if($stream3s_use == 1) selected @endif>@lang('mymo_core::app.enabled')</option>
            <option value="0" @if($stream3s_use == 0) selected @endif>@lang('mymo_core::app.disabled')</option>
        </select>
    </div>

    <div class="form-group">
        <label class="col-form-label" for="stream3s_link">@lang('mymo_core::app.stream3s_link')</label>
    ...
    <div class="form-group">
        <label class="col-form-label" for="stream3s_client_id">@lang('mymo_core::app.client_id')</label>
    ...
    <div class="form-group">
        <label class="col-form-label" for="stream3s_secret_key">@lang('mymo_core::app.secret_key')</label>
