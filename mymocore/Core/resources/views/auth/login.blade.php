            ...
            <div class="cui__auth__authContainer">
                ...
                <div class="cui__auth__containerInner">
                    <div class="text-center mb-5">
                        <h1 class="mb-5 px-3">
                            <strong>@lang('mymo_core::message.login-form.welcome', ['name' => get_config('sitename', 'TAD CMS')])</strong>
                        </h1>

                        <p class="mb-4">
                            @lang('mymo_core::message.login-form.description')
                        </p>
                    </div>

                    <div class="card cui__auth__boxContainer">
                        <div class="text-dark font-size-24 mb-4">
                            <strong>@lang('mymo_core::message.login-form.header')</strong>
                        </div>
                        ...
                        <form action="{{ route('auth.login') }}" method="post" class="mb-4 form-ajax">
                            ...
                            <button type="submit" class="btn btn-primary text-center w-100 mb-2" data-loading-text="@lang('mymo_core::app.please_wait')"><i class="fa fa-sign-in"></i> @lang('mymo_core::app.log-in')</button>

                            <input type="checkbox" name="remember" value="1" checked> @lang('mymo_core::app.remember-me')
                        </form>
                    ...
                    <div class="text-center pt-2 mb-auto">
                        <span class="mr-2">@lang('mymo_core::message.login-form.dont-have-an-account')</span>
