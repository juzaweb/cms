...
namespace Illuminate\Support\Facades {
    ...
    class Blade
    {
        ...
        {            //Method inherited from \Illuminate\View\Compilers\BladeCompiler
            return \Juzaweb\CMS\Support\BladeMinifyCompiler::compileClassComponentOpening(
                $component,
                $alias,
                $data,
                $hash
    ...
    class Request
    {
         ...
         *
         * @param  string|array  $mimeTypes  The associated mime types (the preferred one must be the first as it will
...
namespace TwigBridge\Facade {
    ...
    class Twig
    {
         ...
         * @static
         */
        public static function loadTemplate($cls, $name, $index = null)
        {            //Method inherited from \Twig\Environment
            /** @var \TwigBridge\Bridge $instance */
            return $instance->loadTemplate($cls, $name, $index);
        }
         ...
         * @param  \Twig\class-string<TExtension>  $class
         * @return \Twig\TExtension
         * @static
         */
         ...
         * @param  \Twig\class-string<TRuntime>  $class  A runtime class name
         * @return \Twig\TRuntime The runtime implementation
         ...
         *
         *
         * @param  \Twig\ExtensionInterface[]  $extensions  An array of extensions
         * @static
         */
         ...
         *
         *
         * @return \Twig\ExtensionInterface[] An array of extensions (keys are for internal usage only and should not
         *     be relied on)
         * @static
         */
        public static function getExtensions()
         ...
         * @static
         */
        public static function getTokenParser($name)
        {            //Method inherited from \Twig\Environment
            /** @var \TwigBridge\Bridge $instance */
            return $instance->getTokenParser($name);
        }
         ...
         * @static
         */
        public static function registerUndefinedTokenParserCallback($callable)
        {            //Method inherited from \Twig\Environment
            /** @var \TwigBridge\Bridge $instance */
            return $instance->registerUndefinedTokenParserCallback($callable);
        }
...
namespace Illuminate\Routing {
    ...
    class Router
    {
        ...
        {
            return \Illuminate\Routing\Router::jwResource($uri, $controller, $options);
        }
        ...
        {
            return \Illuminate\Routing\Router::postTypeResource($uri, $controller, $options);
        }
    }
    ...
    class Route
    {
         ...
         * @param  mixed  $roles
         * @static
         * @see \Juzaweb\CMS\Providers\PermissionServiceProvider::registerMacroHelpers()
         */
...
namespace Illuminate\Validation {
    ...
    class Rule
    {
         ...
         */
        public static function modelExists($modelClass, $modelAttribute = 'id', $callback = null)
        {
