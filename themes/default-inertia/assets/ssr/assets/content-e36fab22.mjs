...
function Content({ post }) {
  var _a, _b;
  const categories = ((_a = post.taxonomies) == null ? void 0 : _a.filter((item) => item.taxonomy === "categories")) || null;
  return /* @__PURE__ */ jsxs("div", { className: "article__entry", children: [
    /* @__PURE__ */ jsx("div", { className: "article__image", children: /* @__PURE__ */ jsx(Link, { href: post.url, title: post.title, children: /* @__PURE__ */ jsx("img", { src: post.thumbnail, alt: post.title, className: "img-fluid" }) }) }),
    /* @__PURE__ */ jsxs("div", { className: "article__content", children: [
      categories == null ? void 0 : categories.map((taxonomy) => {
