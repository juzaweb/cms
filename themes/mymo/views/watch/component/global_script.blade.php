<script type="text/javascript">
    var mymo_cfg = {
        ...
        "resume_text": "@lang('app.automatically_replay_the_movie')",
        "resume_text_2": "@lang('app.replay_from_begin')",
        "playback": "@lang('app.playback')",
        "continue_watching": "@lang('app.continue_watching')",
        "player_reload": "@lang('app.player_reload')",
        "jw_error_msg_0": "",
        "jw_error_msg_1": "@lang('app.video_error_can_not_be_played')",
        "jw_error_msg_2": "@lang('app.to_continue_watching_click_reload_player_button')",
        "jw_error_msg_3": "@lang('app.or_click_on_buttons_listed_below')",
        ...
        "is_adult": false,
        "adult_title": "@lang('app.adult_content_warning')",
        "adult_content": "",
        "show_only_once": "@lang('app.show_only_once')",
        "exit_btn": "@lang('app.exit')",
        "is_18plus": "",
        "report_lng": {
            "title": "{{ $info->name }}",
            "alert": "",
            "msg": "@lang('app.content')",
            "msg_success": "@lang('app.thank_you_for_submitting_error_message')",
            "loading_img": "{{ asset('styles/themes/mymo/images/loading.gif') }}",
            "report_btn": "@lang('app.report')",
            "name_or_email": "@lang('app.name')",
