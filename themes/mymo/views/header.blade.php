        ...
        <div class="row" id="headwrap">
                        ...
                        <form id="search-form-pc" name="mymoForm" role="search" action="{{ route('search') }}" method="GET">
                            <div class="form-group">
                                <div class="input-group col-xs-12">
                                    <input id="search" type="text" name="q" value="" class="form-control" data-toggle="tooltip" data-placement="bottom" data-original-title="@lang('mymo::app.press_enter_to_search')" placeholder="@lang('mymo::app.search_movies_or_tv_series')" autocomplete="off" required>
            ...
            <div class="col-md-5 hidden-xs text-right">
                ...
                <div id="get-bookmark" class="box-shadow">
                    <i class="hl-bookmark"></i><span> @lang('mymo::app.bookmark')</span>
                    ...
                    <div class="dropdown">
                        @if(Auth::check())
                            <a href="javascript:void(0)" class="avt" id="userInfo2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <span class="name">@lang('mymo::app.account')</span>
                            </a>
                            <ul class="dropdown-menu login-box" aria-labelledby="userInfo2">
                                @if(\App\User::find(Auth::id())->is_admin)
                                    <li><a href="{{ route('admin.dashboard') }}" data-turbolinks="false"><i class="hl-cog"></i> @lang('mymo::app.admin_panel')</a></li>
                                @endif

                                <li><a href="{{ route('account') }}"><i class="hl-user"></i> @lang('mymo::app.profile')</a></li>

                                <li><a href="{{ route('logout') }}" data-turbolinks="false"><i class="hl-off"></i> @lang('mymo::app.logout')</a></li>
                            </ul>
                        @else
                        <a href="javascript:void(0)" class="avt" id="userInfo">
                            <img src='http://1.gravatar.com/avatar/?s=20&#038;d=mm&#038;r=g' srcset='http://2.gravatar.com/avatar/?s=40&#038;d=mm&#038;r=g 2x' class='avatar avatar-20 photo avatar-default' height='20' width='20' />
                            <span class="name">@lang('mymo::app.login')</span>
                        </a>
                        @endif
                    </div>
                </div>
