            ...
            <div class="profile-usermenu">
                <ul class="nav flex-column">
                    <li class="nav-item {{ request()->is('profile') ? 'active' : '' }}">
                        <a href="{{ url('profile') }}">
                            <i class="fas fa-user"></i> {{ __('itube::translation.profile') }}
                        </a>
                    </li>
                    <li class="nav-item {{ request()->is('profile/notification') ? 'active' : '' }}">
                        <a href="{{ url('profile') }}/notification">
                            <i class="fas fa-bell"></i> {{ __('itube::translation.notification') }}</a>
                    </li>
                    <li class="nav-item {{ request()->is('profile/my-videos*') ? 'active' : '' }}">
                        <a href="{{ url('profile/my-videos') }}">
                            <i class="fas fa-video"></i> {{ __('itube::translation.my_videos') }}</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" data-turbolinks="false" onclick="$('.form-logout').submit()">
                            <i class="fas fa-sign-out-alt"></i> {{ __('itube::translation.logout') }}</a>
                    </li>
                </ul>
            </div>
