<div class="card">
    <div class="card-header bg-primary">
        <h5 class="mb-0 card-title font-weight-bold text-white">@lang('mymo_core::app.basic_seo')</h5>
    </div>

    <div class="card-body">

        <div class="form-group">
            <label class="col-form-label" for="sitemap">@lang('mymo_core::app.sitemap')</label>

            <p><a href="{{ route('sitemap') }}" data-turbolinks="false" target="_blank">{{ route('sitemap') }}</a></p>
        </div>

        <div class="form-group">
            <label class="col-form-label" for="author_name">@lang('mymo_core::app.author_name')</label>
...
<div class="card">
    <div class="card-header bg-primary">
        <h5 class="mb-0 card-title font-weight-bold text-white">@lang('mymo_core::app.movies_page_seo')</h5>
    </div>

    <div class="card-body">

        <div class="form-group">
            <label class="col-form-label" for="movies_title">@lang('mymo_core::app.seo_title')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="movies_keywords">@lang('mymo_core::app.seo_keywords')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="movies_description">@lang('mymo_core::app.seo_meta_description')</label>

            <textarea name="movies_description" id="movies_description" class="form-control" rows="4">{{ get_config('movies_description') }}</textarea>
        </div>

        <div class="form-group">
            <label class="col-form-label" for="movies_banner">@lang('mymo_core::app.movies_banner')</label>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="javascript:void(0)" class="btn btn-primary lfm" data-input="movies_banner" data-preview="banner-movies"><i class="fa fa-upload"></i> @lang('mymo_core::app.choose_image')</a>
                </div>
            </div>
        </div>
...
<div class="card">
    <div class="card-header bg-primary">
        <h5 class="mb-0 card-title font-weight-bold text-white">@lang('mymo_core::app.blog_page_seo')</h5>
    </div>

    <div class="card-body">
        <div class="form-group">
            <label class="col-form-label" for="blog_title">@lang('mymo_core::app.seo_title')</label>

            <input type="text" name="blog_title" id="blog_title" class="form-control" value="{{ get_config('blog_title') }}" autocomplete="off" required>
        </div>

        <div class="form-group">
            <label class="col-form-label" for="blog_keywords">@lang('mymo_core::app.seo_keywords')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="blog_description">@lang('mymo_core::app.seo_meta_description')</label>

            <textarea name="blog_description" id="blog_description" class="form-control" rows="4">{{ get_config('blog_description') }}</textarea>
        </div>

        <div class="form-group">
            <label class="col-form-label" for="blog_banner">@lang('mymo_core::app.blog_banner')</label>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="javascript:void(0)" class="btn btn-primary lfm" data-input="blog_banner" data-preview="banner-blog"><i class="fa fa-upload"></i> @lang('mymo_core::app.choose_image')</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="card">
    <div class="card-header bg-primary">
        <h5 class="mb-0 card-title font-weight-bold text-white">@lang('mymo_core::app.latest_movies_page_seo')</h5>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label class="col-form-label" for="latest_movies_description">@lang('mymo_core::app.seo_meta_description')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="latest_movies_banner">@lang('mymo_core::app.latest_movies_banner')</label>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="javascript:void(0)" class="btn btn-primary lfm" data-input="latest_movies_banner" data-preview="banner-latest_movies"><i class="fa fa-upload"></i> @lang('mymo_core::app.choose_image')</a>
                </div>
            </div>
        </div>
    </div>
