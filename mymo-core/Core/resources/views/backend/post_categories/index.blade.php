    ...
    <div class="cui__utils__content">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="mb-0 card-title font-weight-bold">@lang('mymo_core::app.post_categories')</h5>
                    </div>

                    <div class="col-md-6">
                        <div class="btn-group float-right">
                            <a href="{{ route('admin.post_categories.create') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> @lang('mymo_core::app.add_new')</a>
                    ...
                    <table class="table load-bootstrap-table">
                        <thead>
                            <tr>
                                ...
                                <th data-field="name" data-formatter="name_formatter">@lang('mymo_core::app.title')</th>
                                <th data-width="20%" data-field="description">@lang('mymo_core::app.description')</th>
