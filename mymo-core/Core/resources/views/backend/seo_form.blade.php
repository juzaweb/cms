...
<h5>@lang('mymo_core::app.seo_and_marketing')</h5>

<div class="form-group">
    <label class="col-form-label" for="meta_title">@lang('mymo_core::app.meta_title')</label>
    <input type="text" name="meta_title" id="meta_title" class="form-control" autocomplete="off" value="{{ $model->meta_title }}">
</div>

<div class="form-group">
    <label class="col-form-label" for="slug">@lang('mymo_core::app.meta_description')</label>
...
<div class="form-group">
    ...
    <p class="description">@lang('mymo_core::app.use_comma_to_separate_keyword')</p>
</div>

<div class="form-group">
    <label class="col-form-label" for="slug">@lang('mymo_core::app.slug')</label>
