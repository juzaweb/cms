...
import { SectionContainer, defaultPropsContainer } from './section.type';

export const JW_SectionContainer = (props: Partial<SectionContainer>) => {
  props = {
    ...defaultPropsContainer,
    ...(props as any),
  };
  const { children, marginTop, marginBottom, paddingTop, paddingBottom } =
    props;
  return (
    <section
      className={cx([
    ...
    >
      <div className="container lg:px-8 mx-auto">{children}</div>
    </section>
  );
};
