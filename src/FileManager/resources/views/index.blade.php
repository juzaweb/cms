...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('styles/filemanager/css/cropper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('styles/filemanager/css/dropzone.min.css') }}">
    <link rel="stylesheet" href="{{ asset('styles/filemanager/css/mime-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('styles/filemanager/css/lfm.css') }}">
</head>
<body>
...
<script src="{{ asset('styles/filemanager/js/cropper.min.js') }}"></script>
<script src="{{ asset('styles/filemanager/js/dropzone.min.js') }}"></script>
<script>
