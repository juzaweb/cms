    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="btn-group float-right">
                <a href="{{ route('admin.' . $setting->get('type') . '.taxonomy.create', [$taxonomy]) }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> @lang('mymo::app.add_new')</a>
            </div>
        </div>
    </div>
                ...
                <table class="table mymo-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="name" data-formatter="name_formatter" data-sortable="true">@lang('mymo::app.name')</th>
                            <th data-field="description" data-width="25%" data-sortable="true">@lang('mymo::app.description')</th>
                            <th data-field="total_post" data-width="10%" data-sortable="true" data-align="center">@lang('mymo::app.total_posts')</th>
                            <th data-width="15%" data-field="created_at" data-sortable="true">@lang('mymo::app.created_at')</th>
                        </tr>
                    </thead>
                </table>
            </div>
