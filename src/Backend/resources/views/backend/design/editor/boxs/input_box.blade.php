...
<div class="theme-setting theme-setting--text editor-item">
    ...
    <p><a href="javascript:void(0)" class="load-media" data-input="input-{{ $index }}-{{ $icard }}-{{ $iinput }}" data-preview="review-{{ $index }}-{{ $icard }}-{{ $iinput }}"><i class="fa fa-edit"></i> {{ trans('mymo::app.change') }}</a></p>
