<form method="post" action="{{ route('admin.setting.save') }}" class="form-ajax">
    ...
    <div class="form-group">
        <label class="col-form-label" for="logo">@lang('mymo_core::app.logo') <span class="float-right"><a href="javascript:void(0)" data-input="logo" data-preview="preview-logo" class="file-manager"><i class="fa fa-edit"></i> @lang('mymo_core::app.change_image')</a></span></label>
        <div id="preview-logo">
    ...
    <div class="form-group">
        <label class="col-form-label" for="icon">@lang('mymo_core::app.icon') <span class="float-right"><a href="javascript:void(0)" data-input="icon" data-preview="preview-icon" class="file-manager"><i class="fa fa-edit"></i> @lang('mymo_core::app.change_image')</a></span></label>
        <div id="preview-icon">
    ...
    <div class="form-group">
        <label class="col-form-label" for="banner">@lang('mymo_core::app.banner') <span class="float-right"><a href="javascript:void(0)" data-input="banner" data-preview="preview-banner" class="file-manager"><i class="fa fa-edit"></i> @lang('mymo_core::app.change_image')</a></span></label>
