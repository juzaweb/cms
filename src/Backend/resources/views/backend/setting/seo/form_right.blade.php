<div class="card">
    <div class="card-header bg-primary">
        <h5 class="mb-0 card-title font-weight-bold text-white">@lang('mymo::app.home_page_seo')</h5>
    </div>

    <div class="card-body">

        <div class="form-group">
            <label class="col-form-label" for="title">@lang('mymo::app.seo_title')</label>

            <input type="text" name="title" id="title" class="form-control" value="{{ get_config('title') }}" autocomplete="off" required>
        </div>

        <div class="form-group">
            <label class="col-form-label" for="keywords">@lang('mymo::app.seo_keywords')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="description">@lang('mymo::app.seo_meta_description')</label>

            <textarea name="description" id="description" class="form-control" rows="4">{{ get_config('description') }}</textarea>
        </div>

        <div class="form-group">
            <label class="col-form-label" for="banner">@lang('mymo::app.home_banner')</label>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="javascript:void(0)" class="btn btn-primary lfm" data-input="banner" data-preview="banner-banner"><i class="fa fa-upload"></i> @lang('mymo::app.choose_image')</a>
                </div>
            </div>
        </div>
...
<div class="card">
    <div class="card-header bg-primary">
        <h5 class="mb-0 card-title font-weight-bold text-white">@lang('mymo::app.tv_series_page_seo')</h5>
    </div>

    <div class="card-body">

        <div class="form-group">
            <label class="col-form-label" for="author_name">@lang('mymo::app.seo_title')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="author_name">@lang('mymo::app.seo_keywords')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="tv_series_description">@lang('mymo::app.seo_meta_description')</label>
        ...
        <div class="form-group">
            <label class="col-form-label" for="tv_series_banner">@lang('mymo::app.tv_series_banner')</label>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="javascript:void(0)" class="btn btn-primary lfm" data-input="tv_series_banner" data-preview="banner-tv_series"><i class="fa fa-upload"></i> @lang('mymo::app.choose_image')</a>
                </div>
            </div>
        </div>
...
<div class="card">
    <div class="card-header bg-primary">
        <h5 class="mb-0 card-title font-weight-bold text-white">@lang('mymo::app.social_setting')</h5>
    </div>
