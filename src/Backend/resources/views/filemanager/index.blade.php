...
<head>
    ...
    <title>{{ trans('mymo::lfm.title-page') }}</title>
...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    <a class="navbar-brand invisible-lg d-none d-lg-inline" id="to-previous">
        ...
        <span class="d-none d-lg-inline">{{ trans('mymo::lfm.nav-back') }}</span>
    </a>
    ...
    <div class="ml-auto px-2">
        {{--<a class="navbar-link d-none" id="multi_selection_toggle">
            ...
            <span class="d-none d-lg-inline">{{ trans('mymo::lfm.menu-multiple') }}</span>
        </a>--}}
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-display="grid">
                    ...
                    <span>{{ trans('mymo::lfm.nav-thumbnails') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-display="list">
                    <i class="fas fa-list-ul fa-fw"></i>
                    <span>{{ trans('mymo::lfm.nav-list') }}</span>
                </a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-sort fa-fw"></i>{{ trans('mymo::lfm.nav-sort') }}
                </a>
...
<nav class="bg-light fixed-bottom border-top d-none" id="actions">
    <a data-action="open" data-multiple="false"><i class="fas fa-folder-open"></i>{{ trans('mymo::lfm.btn-open') }}
    </a>
    <a data-action="preview" data-multiple="true"><i class="fas fa-images"></i>{{ trans('mymo::lfm.menu-view') }}
    </a>
    <a data-action="use" data-multiple="true"><i class="fas fa-check"></i>{{ trans('mymo::lfm.btn-confirm') }}
    </a>
</nav>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">{{ trans('mymo::lfm.title-upload') }}</h4>
                    ...
                    <div class="form-group" id="attachment">
                        <div class="controls text-center">
                            <div class="input-group w-100">
                                <a class="btn btn-primary w-100 text-white" id="upload-button">{{ trans('mymo::lfm.message-choose') }}</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary w-100" data-dismiss="modal">{{ trans('mymo::lfm.btn-close') }}</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="notify" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary w-100" data-dismiss="modal">{{ trans('mymo::lfm.btn-close') }}</button>
                <button type="button" class="btn btn-primary w-100" data-dismiss="modal">{{ trans('mymo::lfm.btn-confirm') }}</button>
            </div>
        </div>
    </div>
</div>
