...
<head>
    ...
    <title>{{ trans('mymo::filemanager.title-page') }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('mymo/filemanager/css/cropper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('mymo/filemanager/css/dropzone.min.css') }}">
    <link rel="stylesheet" href="{{ asset('mymo/filemanager/css/mime-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('mymo/filemanager/css/lfm.css') }}">
</head>
<body>
<nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    <a class="navbar-brand invisible-lg d-none d-lg-inline" id="to-previous">
        <i class="fas fa-arrow-left fa-fw"></i>
        <span class="d-none d-lg-inline">{{ trans('mymo::filemanager.nav-back') }}</span>
    </a>
    ...
    <div class="ml-auto px-2">
        {{--<a class="navbar-link d-none" id="multi_selection_toggle">
            ...
            <span class="d-none d-lg-inline">{{ trans('mymo::filemanager.menu-multiple') }}</span>
        </a>--}}
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-display="grid">
                    ...
                    <span>{{ trans('mymo::filemanager.nav-thumbnails') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-display="list">
                    <i class="fas fa-list-ul fa-fw"></i>
                    <span>{{ trans('mymo::filemanager.nav-list') }}</span>
                </a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-sort fa-fw"></i>{{ trans('mymo::filemanager.nav-sort') }}
                </a>
...
<nav class="bg-light fixed-bottom border-top d-none" id="actions">
    <a data-action="open" data-multiple="false"><i class="fas fa-folder-open"></i>{{ trans('mymo::filemanager.btn-open') }}
    </a>
    <a data-action="preview" data-multiple="true"><i class="fas fa-images"></i>{{ trans('mymo::filemanager.menu-view') }}
    </a>
    <a data-action="use" data-multiple="true"><i class="fas fa-check"></i>{{ trans('mymo::filemanager.btn-confirm') }}
    </a>
</nav>
...
<div class="d-flex flex-row">
    ...
    <div id="main">
        ...
        <div id="empty" class="d-none">
            ...
            {{ trans('mymo::filemanager.message-empty') }}
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">{{ trans('mymo::filemanager.title-upload') }}</h4>
                    ...
                    <div class="form-group" id="attachment">
                        <div class="controls text-center">
                            <div class="input-group w-100">
                                <a class="btn btn-primary w-100 text-white" id="upload-button">{{ trans('mymo::filemanager.message-choose') }}</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary w-100" data-dismiss="modal">{{ trans('mymo::filemanager.btn-close') }}</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="notify" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary w-100" data-dismiss="modal">{{ trans('mymo::filemanager.btn-close') }}</button>
                <button type="button" class="btn btn-primary w-100" data-dismiss="modal">{{ trans('mymo::filemanager.btn-confirm') }}</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    var lang = @json(trans('mymo::filemanager'));
    var actions = [
        // {
        //   name: 'use',
        //   icon: 'check',
...
<script src="{{ asset('mymo/filemanager/js/script.js') }}"></script>
<script>
