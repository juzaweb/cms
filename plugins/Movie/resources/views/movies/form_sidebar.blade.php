...
<hr>
<div class="form-group">
    <label class="col-form-label" for="select-types">@lang('movie::app.types') <span><a href="javascript:void(0)" class="add-new-types float-right"><i class="fa fa-plus-circle"></i> @lang('movie::app.add_types')</a></span></label>

    <select id="select-types" name="type_id" class="form-control load-types select-types" data-placeholder="--- @lang('movie::app.type') ---" data-explodes="types-explode">
        @if($type)
    ...
    <div class="form-add-types box-hidden">
        <div class="form-group">
            <label class="col-form-label" for="typesName">@lang('movie::app.type')</label>
            <input type="text" class="form-control" id="typesName" autocomplete="off">
        </div>

        <button type="button" class="btn btn-primary add-type"><i class="fa fa-plus-circle"></i> @lang('movie::app.add_type')</button>
    </div>
</div>
