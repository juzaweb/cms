...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <h5 class="mb-0 card-title font-weight-bold">@lang('app.tv_series')</h5>
        </div>
        ...
        <div class="col-md-6">
            <div class="float-right">
                ...
                <div class="btn-group">
                    <a href="{{ route('admin.tv-series.create') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> @lang('app.add_new')</a>
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            url: '{{ route('admin.tv-series.get-data') }}',
            action_url: '{{ route('admin.tv-series.bulk-actions') }}',
        });
    </script>
