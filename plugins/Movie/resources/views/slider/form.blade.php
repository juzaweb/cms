                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" id="basic-addon2"><input type="checkbox" name="new_tab[]" value="1" @if(@$banner->new_tab == 1) checked @endif> {{ trans('mymo_core::app.open_new_tab') }}</span>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    $("#banners").on('click', '.remove-banner', function () {
        ...
        Swal.fire({
            title: '',
            text: '{{ trans('movie::app.are_you_sure_you_want_to_delete_this_banner') }}',
            type: 'warning',
