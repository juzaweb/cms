                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="btn-group float-right">
                            ...
                            <a href="{{ route('admin.server-stream') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> @lang('movie::app.cancel')</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="key">@lang('movie::app.key')</label>
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="name">@lang('movie::app.base_url')</label>
                            <input type="text" name="base_url" class="form-control" id="base_url" value="{{ $model->base_url }}" autocomplete="off" required>
                        </div>

                        <div class="form-group">
                            <label class="col-form-label" for="name">@lang('movie::app.priority')</label>
