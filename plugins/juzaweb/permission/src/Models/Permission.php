...
/**
 * Juzaweb\Permission\Models\Permission
 *
 * @property int $id
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\Juzaweb\Permission\Models\PermissionGroup[] $group
 * @property-read int|null $group_count
 * @property-read \Illuminate\Database\Eloquent\Collection|Permission[] $permissions
 * @property-read int|null $permissions_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\Juzaweb\Permission\Models\Role[] $roles
