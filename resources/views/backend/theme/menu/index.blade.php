    ...
    <div class="modal fade" id="modal-edit-menu">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary save-menu-item"><i class="fa fa-save"></i> {{ trans('app.save') }}</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times-circle"></i> {{ trans('app.close') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <template id="menu-item">
        <li class='dd-item' id="item-{id}" data-id="{id}" data-content="{content}" data-object_id="{object_id}" data-url="{url}" data-new_tab="{new_tab}" data-object_type="{object_type}">
            ...
            <div class='float-right item-edit'>
                <a href='javascript:void(0)' class="edit-menu-item" title='{{ trans('app.edit') }}'><i class='fa fa-edit'></i></a>
                <a href='javascript:void(0)' class='text-red remove-menu-item' title='{{ trans('app.remove') }}'><i class='fa fa-times-circle'></i></a>
            </div>
            {children}
        </li>
    </template>
