            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="name" class="form-label">{{ trans('app.menu_name') }}</label>
                ...
                <div class="col-md-6">
                    <div class="btn-group float-right">
                        ...
                        <button type="button" class="btn btn-danger delete-menu"><i class="fa fa-trash"></i> {{ trans('app.delete') }}</button>
                    </div>
                </div>
            </div>
        </div>
