...
<div class="cui__utils__content">
    <form method="post" action="{{ route('admin.video_ads.save') }}" class="form-ajax">
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="btn-group float-right">
                            ...
                            <a href="{{ route('admin.video_ads') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> @lang('app.cancel')</a>
                        </div>
                    </div>
                </div>
            </div>
