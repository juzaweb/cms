...
@section('title', trans('app.movie_comments'))

@section('content')

{{ Breadcrumbs::render('manager', [
        'name' => trans('app.movie_comments'),
        'url' => route('admin.movie_comments')
    ]) }}
...
<div class="cui__utils__content">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <h5 class="mb-0 card-title font-weight-bold">@lang('app.movie_comments')</h5>
                </div>
                ...
                <table class="table load-bootstrap-table">
                    <thead>
                        <tr>
                            ...
                            <th data-width="15%" data-field="approved" data-align="center" data-formatter="approve_formatter">@lang('app.approve')</th>
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            url: '{{ route('admin.movie_comments.getdata') }}',
            remove_url: '{{ route('admin.movie_comments.remove') }}',
            status_url: '{{ route('admin.movie_comments.publicis') }}',
        });
    </script>
@endsection