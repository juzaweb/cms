...
<div class="cui__utils__content">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <h5 class="mb-0 card-title font-weight-bold">@lang('app.users')</h5>
                </div>

                <div class="col-md-6">
                    <div class="btn-group float-right">
                        <a href="{{ route('admin.users.create') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> @lang('app.add_new')</a>
                ...
                <table class="table load-bootstrap-table">
                    <thead>
                        <tr>
                            ...
                            <th data-width="15%" data-field="email">@lang('app.email')</th>
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            remove_url: '{{ route('admin.users.remove') }}',
        });
    </script>
@endsection