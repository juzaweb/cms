        ...
        <a class="halim-thumb" href="{{ route('watch', ['slug' => $item->slug]) }}" title="{{ $item->name }}">
            ...
            <div class="icon_overlay" data-html="true"
                 ...
                 data-content="<div class=org-title>{{ $item->other_name }} (2020)</div>                            <div class=film-meta>
                                ...
                                <div class=film-content>Mạnh Hồi là thợ trang điểm kiêm blogger làm đẹp nhưng lại có 1 khuôn mặt mang vết&amp;hellip;</div>
            ...
            <div class="halim-post-title-box">
                <div class="halim-post-title ">
                    <h2 class="entry-title">{{ $item->name }}</h2><p class="original_title">{{ $item->other_name }} (2020)</p>
                </div>
            </div>
        </a>
    </div>