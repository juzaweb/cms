    ...
    <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
        <section id="content">
				...
				<span class="user-rate-image post-large-rate stars-large">
                    ...
                    <div class="movie_info col-xs-12">
                        <div class="movie-poster col-md-3">
                            <img class="movie-thumb" src="wp-content/uploads/2020/04/to-chuc-rugal-14773-thumbnail.jpg" alt="Tổ Chức Rugal">
            ...
            <i class="hl-youtube-play"></i> Trailer</span>
                            ...
                            <span class="btn btn-sm btn-success quick-eps"><a data-toggle="collapse" href="#collapseEps" aria-expanded="false" aria-controls="collapseEps"><i class="hl-sort-down"></i> Chọn tập</a>
            </span>
                        </div>
                        <div class="film-poster col-md-9">
                            <div class="film-poster-img" style="background: url('wp-content/uploads/2020/04/rugal.gif');background-size: cover;background-repeat: no-repeat;background-position: 30% 25%;height: 300px;-webkit-filter: grayscale(100%); filter: grayscale(100%);"></div>
                            <div class="halim-play-btn hidden-xs">

                                <a href="/xem-phim-to-chuc-rugal/tap-1-sv1.html" class="play-btn" title="Click to Play" data-toggle="tooltip" data-placement="bottom">Click to Play</a>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane active halim-ajax-popular-post">
                    ...
                    <div id="halim-ajax-popular-post" class="popular-post">
                        ...
                        <div class="item post-18066">
                            ...
                            <div class="viewsCount">3.1K lượt xem</div>
                        </div>
