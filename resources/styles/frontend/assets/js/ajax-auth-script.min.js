...
jQuery("body").on("click", "#recaptcha-reset-login", function () {
    grecaptcha.reset(widgetId1), $("#recaptcha-reset-login i").addClass("animate-spin"), setTimeout(function () {
        $("#recaptcha-reset-login i").removeClass("animate-spin")
    }, 500)
}), jQuery("body").on("click", "#recaptcha-reset-register", function () {
    grecaptcha.reset(widgetId2), $("#recaptcha-reset-register i").addClass("animate-spin"), setTimeout(function () {
        $("#recaptcha-reset-register i").removeClass("animate-spin")
    }, 500)
}), jQuery("body").on("click", "#recaptcha-reset-forgot-password", function () {
    grecaptcha.reset(widgetId3), $("#recaptcha-reset-forgot-password i").addClass("animate-spin"), setTimeout(function () {
