...
describe('Typeahead Init from one Typeahead jQuery selector', () => {
    ...
    it('Should assign the proper Typeahead selector', () => {
        ...
        expect(window.Typeahead['input'] || window.Typeahead['.js-typeahead']).toBeDefined();

        var hasProperSelector = !!(window.Typeahead['input'] &&
            window.Typeahead['input'].selector ||
...
describe('Typeahead Init from multiple typeahead selectors', () => {
    ...
    beforeAll(() => {
        ...
        document.body.innerHTML = '<input class="js-typeahead"><input class="js-typeahead">';
...
describe('Typeahead Init from multiple typeahead jQuery selectors', () => {
    ...
    beforeAll(() => {
        ...
        document.body.innerHTML = '<input class="js-typeahead"><input class="js-typeahead"><input class="js-typeahead"><input class="js-typeahead">';
