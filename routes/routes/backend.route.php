...
Route::group(['prefix' => 'filemanager'], function () {
    Route::get('/', [
        'uses' => 'Backend\Filemanager\LfmController@show',
    ]);

    Route::get('/errors', [
        'uses' => 'Backend\Filemanager\LfmController@getErrors',
        'as' => 'getErrors',
    ]);

    Route::any('/upload', [
        'uses' => 'Backend\Filemanager\UploadController@upload',
    ])->name('backend.lfm.upload');

    Route::get('/jsonitems', [
        'uses' => 'Backend\Filemanager\ItemsController@getItems',
    ]);
    
    Route::get('/move', [
        'uses' => 'Backend\Filemanager\ItemsController@move',
        'as' => 'move',
    ]);
    
    Route::get('/domove', [
        'uses' => 'Backend\Filemanager\ItemsController@domove',
        'as' => 'domove'
    ]);

    Route::get('/newfolder', [
        'uses' => 'Backend\Filemanager\FolderController@getAddfolder',
        'as' => 'getAddfolder',
    ]);

    Route::get('/folders', [
        'uses' => 'Backend\Filemanager\FolderController@getFolders',
        'as' => 'getFolders',
    ]);
    
    Route::get('/crop', [
        'uses' => 'Backend\Filemanager\CropController@getCrop',
        'as' => 'getCrop',
    ]);
    
    Route::get('/cropimage', [
        'uses' => 'Backend\Filemanager\CropController@getCropimage',
        'as' => 'getCropimage',
    ]);
    
    Route::get('/cropnewimage', [
        'uses' => 'Backend\Filemanager\CropController@getNewCropimage',
        'as' => 'getCropnewimage',
    ]);

    Route::get('/rename', [
        'uses' => 'Backend\Filemanager\RenameController@getRename',
        'as' => 'getRename',
    ]);

    Route::get('/resize', [
        'uses' => 'Backend\Filemanager\ResizeController@getResize',
        'as' => 'getResize',
    ]);
    
    Route::get('/doresize', [
        'uses' => 'Backend\Filemanager\ResizeController@performResize',
        'as' => 'performResize',
    ]);

    Route::get('/download', [
        'uses' => 'Backend\Filemanager\DownloadController@getDownload',
        'as' => 'getDownload',
    ]);

    Route::get('/delete', [
        'uses' => 'Backend\Filemanager\DeleteController@getDelete',
        'as' => 'getDelete',
    ]);
